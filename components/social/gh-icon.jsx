...
export const GithubIcon = ({ target, name, size }) => (
    <Link href={target} passHref>
        <a className={classNames("mx-1 relative", styles.group)} target="_blank" rel="noreferrer" title={name}>
            <div className={classNames("w-6 h-6 rounded-full", styles.hovered)}>
...
const SvgComponent = (props) => (
    <svg
        ...
        {...props}
    >
        <circle cx={248} cy={256} r={248} fill="#fff" />
        <path
